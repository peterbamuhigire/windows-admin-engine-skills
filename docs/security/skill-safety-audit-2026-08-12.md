...
| Command tree changes user PATH | Installer proposes 51 directories and can affect resolution | `ShouldProcess`, canonical deduplication, collision refusal, 8,191-character gate, and scoped uninstall. Controlled. |
